...
<body>
	...
	<div class="container">
		...
		<div class="jumbotron">
			<h1><fmt:message key="form.modify" /> <fmt:message key="prayer.prayer" /></h1>
		</div>

			<form:form commandName="prayer2Change">
				<form:input class="form-control" path="originalEmail" type="hidden"/>
				<div class="table-responsive">
					<table class="table table-striped" width="100%" border="1"
						...
						<tr>
							<td colspan="2">
								<p class="text-danger bg-danger"><form:errors></form:errors></p>
							</td>
						</tr>
					</table>
				</div>
